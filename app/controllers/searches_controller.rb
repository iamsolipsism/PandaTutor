class SearchesController < ApplicationController
  ...
  def index
    #@searches = Search.all
      #@users = Search.search(params[:courseName], params[:university], params[:grade])
...
for index1 in 0 ... @userSize
  for course in @users[index1].courses
